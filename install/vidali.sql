...
CREATE TABLE IF NOT EXISTS `vdl_user` (
  ...
  `n_views` int(10) unsigned zerofill NOT NULL DEFAULT '0000000000',
  `n_contacts` int(10) unsigned zerofill NOT NULL DEFAULT '0000000000',
  `n_groups` int(10) unsigned zerofill NOT NULL DEFAULT '0000000000',
